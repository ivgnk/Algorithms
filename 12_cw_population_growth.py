...
!!! Сколько лет нужно городу, чтобы его население было больше или равно p = 1200 жителей?
...
# !!! население - всегда целое число, которое округляем в меньшую сторону
def nb_year(p0, percent, aug, p):
    pcurr = p0
    year = 0
    while pcurr < p:
        year = year+1
        pcurr = int(pcurr+pcurr*(percent/100)+aug) # !!!
    return year
